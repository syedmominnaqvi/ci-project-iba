...
def scrape_mt_samples(output_dir, max_samples=50, delay=1):
    ...
    print(f"Starting to scrape MTSamples.com...")
    
    # Check if robots.txt allows scraping
    robots_response = requests.get("https://www.mtsamples.com/robots.txt")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Scrape medical transcription samples")
